...
Recognizing the potential value from the initial analysis, the project evolved into a business intelligence dashboard - SweetPulse. The tool provides real-time sales and order volume predictions based on weather forecasts and engineered operational features, as well as interactive visualizations to uncover actionable sales patterns. The objective is to support data-informed decision-making for daily operations planning.

**Highlights:**  

- Trained and deployed Linear and Poisson Regression models using historical sales and weather data to forecast daily revenue and order volumes, achieving prediction errors within 8\% of average sales and 10\% of average orders.

- Incorporated model diagnostics to enable users monitor performance and validity of each forecasting model, helping guide future model retraining and selection efforts.

- Developed a pipeline that enables cafe staff to easily retrain prediction models and refresh dashboard visualizations as new sales data becomes available. 
...
**About the project:**  
One of UBC Cybersecurity's core responsibilities involves protecting UBC email users from phishing attacks. While the team currently employs a machine learning pipeline to classify reported emails, its limited performance necessitates manual review by a human analyst to determine the appropriate course of action – a process made difficult by the high-volume of reported emails and time sensitivity in addressing these threats. 
...
The project was part of the coursework of *DSCI 524 - Collaborative Software Development*, which emphasized incorporating version control, testing, continuous integration, and modular programming in data scientific workflows. 
