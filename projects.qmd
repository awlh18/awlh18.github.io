...
**About the project:**  
One of UBC Cybersecurity's core responsibilities involves protecting UBC email users from phishing attacks. While the team employs machine learning to classify reported emails, the existing model relies solely on word occurrences in the header and body of an email to make predictions, which offers limited performance and necessitates manual review by a human analyst. This process is made difficult by the high-volume of reported emails and time sensitivity in addressing these threats. 
